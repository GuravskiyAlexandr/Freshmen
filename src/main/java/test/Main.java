 ...
 *
 * В классе University создаем группы , потом создаем студентов и закрепляем их за группами и каждую группу закрепляем за профессором так как професор без групп
 * не может.
 */
public class Main {
